...
public class CommandeItemController implements Serializable {
    ...
    @EJB
    private service.CommandeFacade commandeItemFacade;
            ...
            try {
                if (persistAction == PersistAction.CREATE) {
                      getFacade().create(selected);
                                JsfUtil.addSuccessMessage( ResourceBundle.getBundle("/Bundle").getString("CommandeItemCreatedSuccess"));
    ...
    public CommandeFacade getCommandeItemFacade() {
        return commandeItemFacade;
    }

    public void setCommandeItemFacade(CommandeFacade commandeItemFacade) {
